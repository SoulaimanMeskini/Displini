    ...
    <>
      ...
      <div className="min-h-screen pt-24 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <h1 className="text-5xl font-bold mb-4 text-gray-900 dark:text-white">Terms of Use</h1>
          ...
          <div className="prose prose-gray max-w-none dark:prose-invert">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">1. About Displini</h2>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">3. Account Termination</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">5. Payments</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">6. AI Features</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">7. Health Data Disclaimer</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">9. Governing Law</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">10. Changes</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
