  ...
  const roadmap: RoadmapQuarter[] = [
    {
      ...
      status: 'in-progress',
      features: [
        { name: 'Web App Launch', status: 'completed' },
        { name: 'iOS & Android Apps', status: 'in-progress' },
        { name: 'Real-time Sync', status: 'in-progress' }
      ]
    },
    {
      quarter: 'Q1 2026',
    ...
    <>
      ...
      <div className="min-h-screen pt-24" style={{ backgroundColor: colors.background.light }}>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <h1 className="text-5xl font-bold mb-4 text-gray-900">Product Roadmap</h1>
                ...
                <ul className="space-y-4">
                  {quarter.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-3">
                      ...
                      <span className={feature.status === 'completed' ? 'text-gray-500 line-through' : 'text-gray-700'}>
                        {feature.name}
                      </span>
                    </li>
                  ))}
