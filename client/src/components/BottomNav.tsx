import { Heart, Utensils, Dumbbell, CheckSquare, Plus, Calendar, Sparkles } from "lucide-react";
...
export default function BottomNav({ onAddTask, onAiClick }: BottomNavProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 pb-5 px-3 sm:pb-6 sm:px-4">
      ...
      <div className="flex justify-center items-center gap-3">
        ...
        {/* Floating Action Button - Next to nav on the right */}
        {location === '/todo' && onAddTask && (
          <button
            onClick={onAddTask}
