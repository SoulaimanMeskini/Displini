...
interface EmojiPickerProps {
  ...
  category?: "common" | "health" | "sport" | "food" | "work";
}
...
const healthEmojis = ["💊", "💉", "🩺", "🩹", "🌡️", "🧪", "🧬", "🦷", "🦴", "🧠", "🫀", "🫁", "👁️", "👂", "🩸", "💆", "💆‍♂️", "💆‍♀️", "🧖", "🧖‍♂️", "🧖‍♀️"];
      ...
      <div className="flex flex-wrap gap-2 mt-2">
        ...
        {!showAllEmojis && (
          <button
            ...
            className="w-10 h-10 rounded-lg flex items-center justify-center bg-muted hover:bg-muted/80 text-muted-foreground transition-all"
