...
export default function MonthlyStatsModal({ open, onOpenChange }: MonthlyStatsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto" data-testid="dialog-monthly-stats">
        <DialogHeader>
          <DialogTitle>Monthly Statistics - {format(now, 'MMMM yyyy')}</DialogTitle>
        </DialogHeader>
